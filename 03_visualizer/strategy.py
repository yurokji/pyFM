...
class Formation:
	...
	def setFormationType(self, formationType):
		self.__formationType = formationType
	def setPlayerPosition(self, num, position):
		# print(self.__eleven[num])
...
class Strategy:
	def __init__(self, strFormation, strTactics):
		self.__formation = Formation(strFormation)
		self.__tactics = Tactics(strTactics)
